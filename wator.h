...
typedef struct planet {
  unsigned int nrow; /** righe */
  unsigned int ncol; /** colonne */
  cell_t ** w;	/** matrice pianeta */
  int ** btime;	/** matrice contatori nascita (pesci e squali)*/	
  int ** dtime;	/** matrice contatori morte (squali )*/				
} planet_t;

/** struttura che raccoglie le informazioni di simulazione */
typedef struct wator {
  int sd; /** sd numero chronon morte squali per digiuno */
  int sb; /** sb numero chronon riproduzione squali */ 
  int fb; /** fb numero chronon riproduzione pesci */
  int nf; /** nf numero pesci*/
  int ns; /** ns numero squali */
  int nwork; /** numero worker */
  int chronon; /** durata simulazione */
  planet_t* plan; /** pianeta acquatico */
} wator_t;
