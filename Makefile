...
# primo frammento 
FILE_DA_CONSEGNARE1= wator.c help.c help.h main.c visualizer.c myqueue.c myqueue.h myconn.h myconn.c mutex.c mutex.h wator.h

# secondo frammento 
FILE_DA_CONSEGNARE2= wator.c help.c help.h main.c visualizer.c myqueue.c myqueue.h myconn.h myconn.c mutex.c mutex.h wator.h watorscript

# terzo frammento 
FILE_DA_CONSEGNARE3= wator.c help.c help.h main.c visualizer.c myqueue.c myqueue.h myconn.h myconn.c mutex.c mutex.h wator.h watorscript relazione.pdf
...
objects1 = wator.o help.o myqueue.o myconn.o mutex.o
...
cartella:
	[ -d $(LIBDIR) ] || mkdir $(LIBDIR) # crea la cartella ../lib solo se non esiste già	
...
help.o: help.c help.h myconn.h myqueue.h mutex.h
	$(CC) $(CFLAGS) -c $<
...
myqueue.o: myqueue.c myqueue.h help.h mutex.h
	$(CC) $(CFLAGS) -c $< 
	
myconn.o: myconn.c myconn.h wator.h mutex.h
	$(CC) $(CFLAGS) -c $< 
...
main.o: main.c wator.h help.h myqueue.h myconn.h mutex.h
	$(CC) $(CFLAGS) -c $<
	
visualizer: visualizer.o
	$(CC) -o $@ $^ $(LIBS) -lWator -lpthread
	
visualizer.o: visualizer.c wator.h help.h myconn.h mutex.h
	$(CC) $(CFLAGS) -c $<
